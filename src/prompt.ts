...
export function buildPrompt(params: {
  ...
  return [
    ...
    '{"reviews": [{"lineNumber": <diff_line_number>, "endLineNumber": <end_diff_line_optional>, "reviewComment": "<comment>", "priority": "low|medium|high", "category": "<optional>"}]}',
    ...
    'Use endLineNumber only when the issue genuinely spans multiple lines (e.g., a multi-line expression or loop body). endLineNumber must be greater than lineNumber and within the same hunk. Omit it for single-line issues.',
    '',
