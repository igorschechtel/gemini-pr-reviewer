...
| :--- | :---: | :--- | :--- |
| `GITHUB_TOKEN` | ✅ | - | GitHub token to read PR data and post reviews (auto-generated by GitHub). |
| `GEMINI_API_KEY` | ✅ | - | Google Gemini API key. |
| `GEMINI_MODEL` | ❌ | `gemini-flash-latest` | Gemini model to use. See [available models](https://ai.google.dev/gemini-api/docs/models). |
